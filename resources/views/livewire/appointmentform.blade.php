          ...
          <form wire:submit.prevent="store_requested_appointment()">
             <fieldset>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="row">
                       <div class="form-group">
                          <select wire:model="department" name="department" class="form-control">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="row">
                       <div class="form-group">
                          <select wire:model="doctor" name="doctor" class="form-control">
                              <option value="" class="text-red">{{ __('Select Doctor') }}</option>
                              @forelse ($filteredDoctors ?? [] as $doctor)
                              <option value="{{ $doctor->id }}">{{ $doctor->employee->name ?? 'Unknown Employee' }}</option>
                              @empty
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="row">
                      <div class="form-group">
                         <textarea wire:model.lazy="message" rows="4" class="form-control" placeholder="Your Message..."></textarea>
