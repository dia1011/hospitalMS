<div>
    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_employee()">
        <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">
            {{ __('Add New staff member') }}</div>
        <div class="form-group">
            <label for="name">Name</label>
            <input type="text" name="name" id="name" wire:model.lazy="name" placeholder="Enter Member Name"
        ...
        <div class="form-group">
            ...
            <input type="email" name="Email" wire:model.lazy="email" placeholder="Enter Member Email"
                class="form-control" required cols="30" rows="5"></textarea>
        </div>
        @error('email')
            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="number" max="1000000000000" name="phone" wire:model.lazy="phone"
                placeholder="Enter Member Phone" class="form-control" required cols="30"
                rows="5"></textarea>
        </div>
        @error('phone')
            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="Address" wire:model.lazy="address" placeholder="Enter Member Address"
                class="form-control" required cols="30" rows="5"></textarea>
        </div>
        @error('address')
            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="Qualification" wire:model.lazy="qualification"
                placeholder="Enter Member Qualification" class="form-control" required cols="30"
                rows="5"></textarea>
        </div>
        @error('qualification')
            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <select name="Job" wire:model="position" class="form-control" required>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" min="1" name="Salary" wire:model.lazy="salary"
                placeholder="Enter Member Salary" class="form-control" required cols="30"
                rows="5"></textarea>
        </div>
        @error('salary')
            <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
