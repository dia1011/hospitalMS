                ...
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_patient()">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Gender" wire:model.lazy="gender" class="form-control">
                                <option class="text-red">Select Status</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="Blood" wire:model.lazy="bloodgroup" class="form-control">
                                <option value="" class="text-red">Select Blood Group</option>
