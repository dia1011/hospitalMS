    ...
    <div class="wrapper">
        <nav id="sidebar" class="active mt-4">
            <ul class="mt-5 list-unstyled components text-secondary">
                {{-- @auth --}}
                <li>
                    <a href="{{ route('admin_dashboard') }}"><i class="fa-solid fa-house"></i> Dashboard</a>
                </li>
                {{-- <li>
                    <a href="{{ route('admin_docters') }}"><i class="fas fa-file-alt"></i>Docters</a>
                </li>  --}}
                <li>
                    <a href="{{ route('admin_operations_report') }}"><i class="fas fa-file-alt"></i>OPD
                        report</a>
                </li>
                ...
                <li> 
                    <a href="{{ route('employees') }}"><i class="fas fa-file-alt"></i>Staff</a>
                </li>
                <li>
                    <a href="{{ route('doctors') }}"><i class="fas fa-file-alt"></i>Doctors</a>
                </li>
                {{-- <li>
                ...
                <li>
                    <a href="{{ route('patient_bills') }}"><i class="fas fa-file-alt"></i>Invoice's</a>
                </li>
